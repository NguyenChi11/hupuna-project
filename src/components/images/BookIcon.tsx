// components/BookIcon.tsx  (hoặc bất kỳ tên nào bạn thích)
...
const BookIcon = ({ size = 24, className = "", ...props }: BookIconProps) => {
  return (
    <svg
      width={size}
      height={size}
